...
public class BinarySearchTree implements BSTInterface {
    ...
    //should only be one difference between these two one goes left one goes right.
    public Comparable min() {
        //start at root go to root.left.
        BSTNode current = root.getLeft();
    ...
    public Comparable max() {
        //start at root go to root.right.
        BSTNode current = root.getRight();
